...
import { ArrowRight, CheckCircle2, Layers, Tag, ExternalLink } from "lucide-react";
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    {project.liveUrl && (
                      <a
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold shadow-xs transition-all hover:shadow-emerald-600/20"
                      >
